            ...
            <div className='mt-20 md:mt-5 shadow-lg px-3 py-5 rounded-xl bg-white'>
                <form>
                    ...
                    <div className="my-5">
                        ...
                        <input type="email" placeholder="Registra tu email" className="border w-full p-3 mt-3 bg-gray-50 rounded-xl" />
                    </div>
                    ...
                    <div className="my-5">
                        ...
                        <input type="password" placeholder="Confirma tu password" className="border w-full p-3 mt-3 bg-gray-50 rounded-xl" />
                    </div>
